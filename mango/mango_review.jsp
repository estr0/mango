...
<head>
	...
	<link rel="stylesheet" href="../mango_css/mango_review.css">
	<script src="https://code.jquery.com/jquery-3.6.1.js" integrity="sha256-3zlB5s2uwoUzrXK3BT7AX3FyvojsraNFxCc2vC/7pNI=" crossorigin="anonymous"></script>
	<script>
		$(function(){
			$(".tastylike").click( function(){
				idx = $(".tastylike").index($(this));
				if(idx==0) $("#input_tastylike").val("맛");
				else if(idx==1) $("#input_tastylike").val("괜");
				else if(idx==2) $("#input_tastylike").val("별");
			...
			$(".review_cancel_btn").eq(1).click( function(){
				location.href = "mango_details.jsp";
			});
	...
	<div id="review_writingpage">
		<form action="../ReviewWriteServlet" method="post">
						...
						<div class="review_writingpage_contentwrap1">
							<div class="review_writingpage_contentwrap2">
								<div class="review_writingpage_contentwrap3">
									...
									<textarea class="review_content" maxlength="10000" name="review" placeholder="존맛탱님, 주문하신 메뉴는 어떠셨나요? 식당의 분위기와 서비스도 궁금해요!"></textarea>
			...
			<div class="review_writingpage_buttons">
				<button class="review_later_button_Deactive">나중에 이어쓰기</button>
				<div class="review_writing_button_wrap">
					<button class="review_cancel_button">취소</button>
