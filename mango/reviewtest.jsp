...
/* height: 590.725px; */
		...
		.review_content{
 		...
 		.review_content:focus {
			outline: none;	/* 이게 없으면, textarea에 클릭만 한 상태에서는, 커서가 아직 보이지 않음 */
			caret-color: #CBCBCB;
		}
...
<body>
	<div id="review_writingpage">
		<div class="review_writingpage_title">
			<strong class="fl review_writingpage_restaurant_name">농민백암왕순대</strong>
					...
					<div class="review_writingpage_contentwrap1">
						<div class="review_writingpage_contentwrap2">
							<div class="review_writingpage_contentwrap3">
								...
								<textarea class="review_content" maxlength="10000" placeholder="존맛탱님, 주문하신 메뉴는 어떠셨나요? 식당의 분위기와 서비스도 궁금해요!" value="0"></textarea>
		...
		<div class="review_writingpage_buttons">
			...
			<div class="review_writing_button_wrap">
				...
				<button class="review_summit_button review_summit_button_Deactive">리뷰 올리기</button>
			</div>
